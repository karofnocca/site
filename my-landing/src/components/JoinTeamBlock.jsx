...
const JoinTeamBlock = () => {
  // Функцию scrollToForm можно удалить, если она больше не используется в этом блоке
  
  return (
    <section id="join-team" className="w-full bg-white py-12 lg:py-24 px-4 md:px-10 overflow-hidden">
        ...
        <div className="relative w-full z-10">
          ...
          <div className="relative z-20 px-6 py-16 md:py-24 lg:px-20 text-center flex flex-col items-center">
            ...
            <a 
              ...
              className="inline-block w-full sm:w-auto border-2 border-white bg-transparent hover:bg-white text-white hover:text-[#FF4F01] transition-all duration-300 rounded-[4px] px-10 py-4 font-bold text-[18px] md:text-[22px] uppercase active:scale-95 shadow-lg text-center"
            >
              Подробнее
            </a>
          </div>
